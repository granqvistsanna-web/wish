...
- **Särskiljande drag**: Gammal axelskada från Sektor 14 som aldrig läkt ordentligt. Värker mot madrassen.

## Bakgrund
- **Ursprung**: Född på andra sidan muren. Korsat muren som spädbarn med sin mor i mörker, regn och panik.
- **Befattning/Roll**: Officiellt — tekniker från Energidepartementets underhållsenhet. I verkligheten — teknisk inspektör/undercover agent.
- **Nyckelhistorik**:
  1. Korsat muren som barn med sin mor
  2. Modern dog i en händelse som "officiellt aldrig inträffat"
  3. Skadad i Sektor 14 (axelskada, tydligen strid/explosion)
  4. Blev agent/inspektör — inte teknisk nog för tekniker, inte social nog för agent, hamnade som teknisk inspektör undercover
...
## Röst
- **Talmönster**: Kortfattad, kontrollerad. Ger aldrig mer information än nödvändigt.
- **Vokabulärnivå**: Utbildad, teknisk, men utan Capitol-klang
- **Verbala tics**: Svarar med motfrågor. Delar "ofarliga sanningar" som strategi för att bygga förtroende (t.ex. "jag älskar lukten av mynta").
- **Vad hon aldrig säger**: Var hon egentligen kommer ifrån. Vad hon verkligen gör. Vad som hände med hennes mor.
